...
export const tools: Tool[] = [
  ...
  },
  {
    ...
    description:
      "Evaluate password strength locally with instant feedback and clear improvement suggestions.",
  ...
  },
  {
    ...
    description:
      "Generate responsive CSS clamp() expressions with live preview.",
  ...
  },
  {
    ...
    description:
      "Build Tailwind CSS utility classes visually with live preview and copyable output.",
  ...
  },
  {
    ...
    description:
      "Build CSS box-shadow styles with live preview, sliders, and copyable output.",
  ...
  },
  {
    ...
    description:
      "Configure Flexbox layouts visually and generate CSS with a live preview.",
  ...
  },
  {
    ...
    description:
      "Generate rounded-corner CSS with a live preview and copy-ready border-radius output.",
  ...
  },
  {
    ...
    description:
      "Count characters, words, sentences, and paragraphs in real time, with reading and speaking time estimates.",
